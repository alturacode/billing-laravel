...
final class BillingLaravelServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(BillableDetailsResolver::class, DefaultBillableDetailsResolver::class);
        $this->app->bind(UsageMeter::class, UsageLedger::class);
    ...
    private function registerRepositories(): void
    {
        ...
        $usageLedger = $this->app['config']->get('billing.repositories.usage_ledger', EloquentUsageLedger::class);
        $this->app->bind(UsageLedger::class, $usageLedger);
    }
}
